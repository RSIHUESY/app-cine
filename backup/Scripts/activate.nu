...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Rodrigo\Downloads\ClaseAppMovil\backup\certus_back'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Rodrigo\Downloads\ClaseAppMovil\backup\certus_back\Scripts\deactivate.nu'
