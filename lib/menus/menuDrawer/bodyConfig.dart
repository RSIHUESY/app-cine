...
class BodyConfig extends StatefulWidget {
  const BodyConfig({Key? key}) : super(key: key);

  @override
  State<BodyConfig> createState() => _BodyConfigState();
}

class _BodyConfigState extends State<BodyConfig> {
  @override
