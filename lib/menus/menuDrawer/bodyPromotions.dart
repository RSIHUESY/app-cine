...
class BodyPromotions extends StatefulWidget {
  const BodyPromotions({Key? key}) : super(key: key);

  @override
  State<BodyPromotions> createState() => _BodyPromotionsState();
}

class _BodyPromotionsState extends State<BodyPromotions> {
  @override
